...
//Filter Status
TestObject dropdownStatus = new TestObject()
dropdownStatus.addProperty("xpath", ConditionType.EQUALS, "//div[contains(@class,'cursor-pointer') and .//select]")
WebUI.click(dropdownStatus)
WebUI.delay(0.5) 
TestObject optionApproved = new TestObject()
optionApproved.addProperty("xpath", ConditionType.EQUALS, "//div[contains(@class,'hover:bg-blue-50') and text()='Approved']")
WebUI.click(optionApproved)

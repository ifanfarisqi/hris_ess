...
approvedOption.addProperty("xpath", ConditionType.EQUALS, "//div[contains(text(), 'Waiting For Approval') and contains(@class, 'cursor-pointer')]")
WebUI.click(approvedOption)


//Select Date
String rangeTanggal = "2025-07-31 - 2025-08-03"
String jsScript = """

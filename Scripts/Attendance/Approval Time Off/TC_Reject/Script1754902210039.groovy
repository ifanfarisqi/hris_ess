...
//Reject
TestObject btnReject = new TestObject()
btnReject.addProperty("xpath", ConditionType.EQUALS, "//button[contains(@class, 'bg-danger') and text()='Reject']")
...
WebUI.setText(inputNote, "test ditolak")
...
//Verify
TestObject txtReject = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="swal2-html-container"]/div/div')
WebUI.waitForElementVisible(txtReject, 15)
WebUI.verifyElementPresent(txtReject, 5)
...
//Verify Reject
TestObject txtReject1 = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="swal2-html-container"]/div/div')
WebUI.waitForElementVisible(txtReject1, 15)
WebUI.verifyElementPresent(txtReject1, 5)

TestObject btnOkReject = new TestObject()
btnOkReject.addProperty("xpath", ConditionType.EQUALS, "//button[@type='button' and contains(@class,'swal2-confirm') and normalize-space()='OK']")
WebUI.click(btnOkReject)

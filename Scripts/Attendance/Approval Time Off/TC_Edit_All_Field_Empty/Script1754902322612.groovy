...
//Edit
TestObject btnEdit = new TestObject()
btnEdit.addProperty("xpath", ConditionType.EQUALS, "//button[contains(@class,'btn-primary-outline')]//p[normalize-space()='Edit']")
WebUI.click(btnEdit)


//Button Save
TestObject btnSave = new TestObject()
btnSave.addProperty("xpath", ConditionType.EQUALS, "//button[@type='submit' and contains(@class,'btn-primary')]")
WebUI.click(btnSave)


//Verify Message Error
TestObject verifyMessageErrorCatagory = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//span[normalize-space(text())='Category is required']")
WebUI.waitForElementVisible(verifyMessageErrorCatagory, 15)
WebUI.verifyElementPresent(verifyMessageErrorCatagory, 5)
TestObject verifyMessageErrorNote = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//span[normalize-space(text())='Notes is required']")
WebUI.waitForElementVisible(verifyMessageErrorNote, 15)
WebUI.verifyElementPresent(verifyMessageErrorNote, 5)

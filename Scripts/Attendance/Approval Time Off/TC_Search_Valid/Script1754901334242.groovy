...
TestObject txtDashboard = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//p[contains(@class,'text-primary-100') and normalize-space()='Dashboard']")
...
WebUI.delay(0.5)
TestObject btnTimeOff = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//li[@role='menuitem' and normalize-space()='Time Off Approval']")
...
WebUI.setText(inputSearch, "Cuti Sakit")
WebUI.delay(5)

...
//Field Category
TestObject categorySelect = new TestObject('categorySelect')
categorySelect.addProperty('xpath', ConditionType.EQUALS, "//select[contains(@class,'flex-grow-1')]")
WebUI.click(categorySelect)

TestObject selectValueCategory = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//div[normalize-space()='Cuti Melahirkaan']")
...
WebUI.setText(inputNote, "Ubah Catatan Cuti")

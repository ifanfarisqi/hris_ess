...
//View Detail Data Working Day Change
TestObject viewDetail = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/div[3]/div/div[1]/div')
WebUI.click(viewDetail)
TestObject txtDetail = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/div/main/div[2]/div[1]/div/h1')
WebUI.verifyElementPresent(txtDetail, 5)


//Download File
TestObject btnDownload = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/div/main/div[2]/div[2]/div[1]/div[5]/div/div')

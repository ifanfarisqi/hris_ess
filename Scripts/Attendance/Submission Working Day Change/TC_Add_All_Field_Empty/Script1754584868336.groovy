...
TestObject errorMassageWork = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/div/main/div[2]/form/div[1]/div[1]/span')
WebUI.verifyElementPresent(errorMassageWork, 8)
TestObject errorMassageReplacement = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/div/main/div[2]/form/div[1]/div[2]/span')
WebUI.verifyElementPresent(errorMassageReplacement, 8)
TestObject errorMassageNote = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/div/main/div[2]/form/div[1]/div[3]/span')
WebUI.verifyElementPresent(errorMassageNote, 8)
TestObject errorMassageMember = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/div/main/div[2]/form/div[1]/div[6]/span')
WebUI.verifyElementPresent(errorMassageMember, 8)

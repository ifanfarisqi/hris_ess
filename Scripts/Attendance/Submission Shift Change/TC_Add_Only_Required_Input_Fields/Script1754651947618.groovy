...
WebUI.delay(0.5)
TestObject btnOk = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="swal2-html-container"]/div/div')
WebUI.click(btnOk)
WebUI.delay(1)
...
TestObject btnSuccessOk = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//button[contains(@class, 'swal2-confirm')]")
WebUI.click(btnSuccessOk)
WebUI.delay(1)
TestObject heading = new TestObject()
heading.addProperty("xpath", ConditionType.EQUALS, "//h1[text()='Shift Change Request']")

...
//Button Submit
TestObject btnSubmit = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//button[@type='submit' and contains(@class, 'btn-primary')]")
WebUI.click(btnSubmit)
WebUI.delay(0.5)


//Massage Error Verify
TestObject txtWorkSchedule = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/div[2]/form/div[1]/div[1]/span')
WebUI.verifyElementPresent(txtWorkSchedule, 3)
TestObject txtReplacementSchedule = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/div[2]/form/div[1]/div[2]/span')
WebUI.verifyElementPresent(txtReplacementSchedule, 3)
TestObject txtReplacementEmployee = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/div[2]/form/div[1]/div[3]/div/span')
WebUI.verifyElementPresent(txtReplacementEmployee, 3)
TestObject txtNote = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/div[2]/form/div[1]/div[4]/span')
WebUI.verifyElementPresent(txtNote, 3)
TestObject txtMember = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/div[2]/form/div[1]/div[7]/span')
WebUI.verifyElementPresent(txtMember, 3)

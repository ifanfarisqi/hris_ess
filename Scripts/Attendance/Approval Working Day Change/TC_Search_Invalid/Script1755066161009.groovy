...
//Search
TestObject searchFailed = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/div[2]/div[1]/div/div/input')
WebUI.setText(searchFailed, 'QDQDAADADQWQ')
WebUI.delay(5)

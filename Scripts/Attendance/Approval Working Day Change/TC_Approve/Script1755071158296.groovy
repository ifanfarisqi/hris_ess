...
WebUI.delay(0.5)
TestObject btnWorkingDayChange= new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/header/nav/div/div[1]/div/div/div/ul/li[2]/ul/li[3]/ul/a[3]/li')
WebUI.click(btnWorkingDayChange)
WebUI.delay(0.5)
TestObject txtWorkingDayChange = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//h1[normalize-space(text())='Working Day Change Approval']")
WebUI.waitForElementVisible(txtWorkingDayChange, 15)
WebUI.verifyElementPresent(txtWorkingDayChange, 5)


//Detail Data Working Day Change
...
WebUI.setText(inputNote, "test di approve working day change")
...
TestObject txtWorkingDayChange1 = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//h1[normalize-space(text())='Working Day Change Approval']")
WebUI.waitForElementVisible(txtWorkingDayChange1, 15)
WebUI.verifyElementPresent(txtWorkingDayChange1, 5)
WebUI.delay(3)

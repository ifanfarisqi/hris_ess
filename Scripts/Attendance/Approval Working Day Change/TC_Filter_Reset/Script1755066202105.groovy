...
//Select Date
String rangeTanggal = "2025-03-04 - 2025-03-05"
String jsScript = """
...
btnReset.addProperty("xpath", ConditionType.EQUALS, "//button[contains(@class, 'btn-primary') and contains(@class, 'bg-gray-300') and text()='Reset']")

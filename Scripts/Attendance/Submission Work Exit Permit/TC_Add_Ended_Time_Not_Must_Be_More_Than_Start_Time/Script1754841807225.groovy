...
TestObject clickValueHoursFirstDuration = new TestObject().addProperty("xpath", ConditionType.EQUALS, '/html/body/div[2]/div/div/div/div[2]/div[1]/ul/li[22]')
...
TestObject clickValueHoursSecondDuration = new TestObject().addProperty("xpath", ConditionType.EQUALS, '/html/body/div[3]/div/div/div/div[2]/div[1]/ul/li[20]')
...
TestObject massageError = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/form/div[1]/div[2]/div[2]/div[1]/div')
WebUI.verifyElementPresent(massageError, 5)

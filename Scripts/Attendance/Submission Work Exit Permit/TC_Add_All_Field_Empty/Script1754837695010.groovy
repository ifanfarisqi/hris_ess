...
TestObject errorMassageCategory = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/form/div[1]/div[1]/div/span')
WebUI.verifyElementPresent(errorMassageCategory, 3)
TestObject errorMassageStartDate = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/form/div[1]/div[2]/div[2]/div[1]/div[1]')
WebUI.verifyElementPresent(errorMassageStartDate, 3)
TestObject errorMassageStartTime = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/form/div[1]/div[2]/div[2]/div[1]/div[2]')
WebUI.verifyElementPresent(errorMassageStartTime, 3)
TestObject errorMassageEndTime = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/form/div[1]/div[2]/div[2]/div[1]/div[3]')
WebUI.verifyElementPresent(errorMassageEndTime, 3)
...
TestObject errorMassageMember = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/main/div[2]/form/div[3]/div[2]/div[1]/span')
WebUI.verifyElementPresent(errorMassageMember, 3)

...
//Button Reject
TestObject btnReject = new TestObject('btnReject')
btnReject.addProperty('xpath', ConditionType.EQUALS, "//button[normalize-space(text())='Reject']")
...
WebUI.setText(inputNote, "Test Approve Overtime")
...
TestObject txtOverTime1 = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//h1[normalize-space(text())='Overtime Approval']")
WebUI.waitForElementVisible(txtOverTime1, 15)
WebUI.verifyElementPresent(txtOverTime1, 5)

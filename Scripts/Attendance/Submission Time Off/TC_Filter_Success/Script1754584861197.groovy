...
TestObject opsiKhitan = new TestObject()
opsiKhitan.addProperty("xpath", ConditionType.EQUALS, "//div[contains(text(), 'Cuti Khitan/Baptis Anak') and contains(@class, 'cursor-pointer')]")
WebUI.click(opsiKhitan)


//Select Date
String rangeTanggal = "25-08-2025 - 25-08-2025"
String jsScript = """

...
//Button Submit
TestObject btnSubmit = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@id='root']/div[2]/div/main/div[2]/form/div[4]/button")
...
WebUI.delay(1)
TestObject btnSuccessOk = new TestObject().addProperty("xpath", ConditionType.EQUALS, "/html/body/div[2]/div/div[6]/button[3]")

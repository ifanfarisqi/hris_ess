...
TestObject selectMember = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@id='root']/div[2]/div/main/div[2]/form/div[3]/div[2]/div[1]/div")
WebUI.click(selectMember)
TestObject searchMember = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@id='root']/div[2]/div/main/div[2]/form/div[3]/div[2]/div[1]/div/div/div[2]/input")
WebUI.setText(searchMember, 'V')
TestObject selectValueMember = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@id='root']/div[2]/div/main/div[2]/form/div[3]/div[2]/div[1]/div/div/div[3]")
...
WebUI.delay(0.5)
TestObject clickOk = new TestObject().addProperty("xpath", ConditionType.EQUALS, "/html/body/div[2]/div/div[6]/button[3]")
WebUI.click(clickOk)
WebUI.delay(2)
...
WebUI.delay(1)
TestObject clickSuccessOk = new TestObject().addProperty("xpath", ConditionType.EQUALS, "/html/body/div[2]/div/div[6]/button[3]")
WebUI.click(clickSuccessOk)
WebUI.delay(2)

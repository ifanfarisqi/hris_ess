...
//Click Button Submit
TestObject clickSubmit = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@id='root']/div[2]/div/main/div[2]/form/div[4]/button")
WebUI.click(clickSubmit)
WebUI.delay(0.5)

TestObject txtCategoryRequired = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@id='root']/div[2]/div/main/div[2]/form/div[1]/div[1]/div/span")
WebUI.verifyElementPresent(txtCategoryRequired, 5)
TestObject txtDateSingleRequired = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@id='root']/div[2]/div/main/div[2]/form/div[1]/div[3]/div[2]/div[2]/div/div[1]")
WebUI.verifyElementPresent(txtDateSingleRequired, 5)
TestObject txtDateMultipleRequired = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@id='root']/div[2]/div/main/div[2]/form/div[1]/div[3]/div[2]/div[2]/div/div[2]")
WebUI.verifyElementPresent(txtDateMultipleRequired, 5)
TestObject txtNoteRequired = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@id='root']/div[2]/div/main/div[2]/form/div[2]/div[1]/span")
WebUI.verifyElementPresent(txtNoteRequired, 5)
TestObject txtNortifyRequired = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@id='root']/div[2]/div/main/div[2]/form/div[3]/div[2]/div[1]/span")
WebUI.verifyElementPresent(txtNortifyRequired, 5)

...
//Massage Error Field Empty
TestObject txtError = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//*[@id='root']/div[2]/div/main/div[2]/form/div[3]/div[2]/div[1]/span")
WebUI.verifyElementPresent(txtError, 5)

...
public class OvertimePageApproval {
	...
	private TestObject clickMenuOverTime = new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="root"]/div[2]/div/header/nav/div/div[1]/div/div/div/ul/li[2]/ul/li[3]/ul/a[2]/li')
	private TestObject lblOverTime = new TestObject().addProperty("xpath", ConditionType.EQUALS, "//h1[normalize-space(text())='Overtime Approval']")
	...
	//Button
	private TestObject clickBtnApprove = new TestObject('btnApprove').addProperty('xpath', ConditionType.EQUALS, "//button[normalize-space(text())='Approve']")
	...
	private TestObject clickBtnReject = new TestObject('btnReject').addProperty('xpath', ConditionType.EQUALS, "//button[normalize-space(text())='Reject']")
	...
	private TestObject selectValueStatusFilter = new TestObject().addProperty('xpath', ConditionType.EQUALS, "//div[text()='Waiting For Approval']")
	...
	def verifyLblOvertime() {
		WebUI.click(lblOverTime)
	}

	def overtimeApprove(String note) {
	...
	def overtimeReject(String note) {
		WebUI.click(dataDetail)
